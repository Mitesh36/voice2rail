...
<body>
        ...
        <div class="container">
           ...
           <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                        <a href="Booking.php">Booking Tickets<span class="badge"><?php echo " $num_rows1";?></span></a>
                    </li>
					...
					<li>
                        <a href="change_status.php">Status Change<span class="badge"><?php echo " $num_rows1";?></span></a>
                    </li>
	...
	<div class="tpm">
	<?php 
	while($s=mysqli_fetch_array($resa))
	{ ?>
