...
else
{
	...
	$qr="UPDATE status set curr_status = 'approved' where Complaint_no='$ticket'";
	$rs = mysqli_query($conn,$qr);
	if($rs)
	{
		
		$message = "You Compaint has been underprocess... check the Status it has been change <h2>Your complaint id is: $ticket</h2>";
